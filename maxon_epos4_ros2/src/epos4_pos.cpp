...
public:
  Epos4_Pos_Node(): Node("epos4_cmd_pos_node")
  {
    ...
    client_driver_pos_mode_ = this->create_client<std_srvs::srv::Trigger>("/cia402_device_1/position_mode");
    client_driver_csp_mode_ = this->create_client<std_srvs::srv::Trigger>("/cia402_device_1/cyclic_position_mode");
